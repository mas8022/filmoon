    ...
    <>
      {role === "USER" || role === "ADMIN" ? (
        <>
          <div className="cursor-pointer relative">
            <div onClick={() => setSlideProfile((p) => !p)}>
              <div className="center p-[9px] sm:p-[10px] rounded-full cursor-pointer border-2">
                <FaUser
            ...
            <div
              className={`z-[10000] flex flex-col gap-10 items-center py-10 px-4 absolute top-24 -left-20 w-[30rem] border-y-2 border-third rounded-3xl transition-all duration-300 ${
                slideProfile
        ...
        <>
          <Link
            href={"/login"}
            className={`center p-[9px] rounded-full cursor-pointer border-2 ${
          ...
          >
            <svg
              ...
              strokeWidth={"1.4"}
              stroke="black"
              className="sm:size-10 size-7 active:scale-95 stroke-third"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
